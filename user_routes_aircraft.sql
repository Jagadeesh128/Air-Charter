...
CREATE TABLE `routes` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_32D5C2B3846E2F5C` (`aircraft_id`),
  CONSTRAINT `FK_32D5C2B3846E2F5C` FOREIGN KEY (`aircraft_id`) REFERENCES `aircraft` (`id`) ON DELETE SET NULL
...
INSERT INTO `routes` VALUES (1,23,'Chennai','Goa'),(2,24,'mumbai','pune'),(3,25,'delhi','jaipur'),(4,26,'bengaluru','hyderabad'),(5,27,'kolkata','tirupati');
...
INSERT INTO `user` VALUES (10,'tom@gmail.com','[\"ROLE_USER\", \"ROLE_ADMIN\"]','$2y$13$wiskTaHB7H0IlK/QrCedEOyc8Z3xV0YqgwOqmRhIwOhu6.Y.Eot6a','Tom Curise'),(11,'jaga@gmail.com','[\"ROLE_USER\", \"ROLE_ADMIN\"]','$2y$13$gM7muQpp9OlSywSGzCc8zeElSxaNL7AM3x9GL.SMFQF/XVFmXrcDO','Jagadeesh G');
...
-- Dump completed on 2025-07-20 12:55:34
